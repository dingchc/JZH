...
abstract class BaseViewModel(app: Application) : AndroidViewModel(app) {
    ...
    fun gotoWxMiniProgram(liveId: Int) {
        ...
        val path : String = if (liveId < 0) Constants.WX_MINI_PROGRAM_PATH else Constants.WX_MINI_PROGRAM_PATH + "&live_id=" + liveId

        val req = WXLaunchMiniProgram.Req()
        // 填小程序原始id
        req.userName = Constants.WX_MINI_PROGRAM_USER_NAME
        req.path = path
        // 可选打开 开发版，体验版和正式版
